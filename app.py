...
def main():
    ...
    # "What's the best way to communicate to a disc type {} if I'm trying to {} to them {}?

    # create text_input for verb
    verb = st.text_input("Enter a verb e.g., sell or talk", "sell")

    # create text_input for product
    product = st.text_input("Enter a product type e.g., a Saas product or a car", "a product")

    # Create a button to run the LLM generator
    if st.button("Generate Content"):
        # run LLM generator 
        result = generate_text(option1, verb, product, api_key_input, pinecone_index)
